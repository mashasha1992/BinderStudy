package com.ss.testservernoaidl.simulateAIDL;
...
public abstract class AMusicStub extends Binder implements IMusicInterface {
  ...
  private static final java.lang.String DESCRIPTOR = "com.ss.testservernoaidl.simulateAIDL.IMusicInterface";

  public AMusicStub() {
    this.attachInterface(this, DESCRIPTOR);
  }

  public static IMusicInterface asInterface(android.os.IBinder obj) {
    if ((obj == null)) {
      return null;
    }
